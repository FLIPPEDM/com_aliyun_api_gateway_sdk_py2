...
from com_aliyun_api_gateway_sdk_py2.util import UUIDUtil, DateUtil
from com_aliyun_api_gateway_sdk_py2.http.response import Response
from com_aliyun_api_gateway_sdk_py2.auth import md5_tool, signature_composer, sha_hmac256
...
class DefaultClient:
    ...
    def execute(self, request=None):
        try:
            ...
            response = Response(host=request.get_host(),
                                url=request.get_url(),
    ...
    def build_headers(self, request=None):
        ...
        if constant.HTTP_HEADER_ACCEPT in header_params and header_params[constant.HTTP_HEADER_ACCEPT]:
